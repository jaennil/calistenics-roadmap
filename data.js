...
const EXERCISES_WITH_GIF = new Set([
    ...
    "s1-10", "s1-11", "s1-12", "s1-13", "s1-14", "s1-15", "s1-16", "s1-17",
    "s2-1", "s2-2", "s2-3", "s2-4", "s2-5", "s2-6", "s2-7", "s2-8",
    "s2-9", "s2-10", "s2-11", "s2-12", "s2-14", "s2-15", "s2-17", "s2-18",
    "s3-1", "s3-3", "s3-4", "s3-5", "s3-6", "s3-10", "s3-11", "s3-12",
    "s3-13", "s3-14", "s3-15", "s3-16", "s3-18",
    "s4-1", "s4-2", "s4-3", "s4-4", "s4-5", "s4-6", "s4-7", "s4-8", "s4-9",
    "s5-2", "s5-3", "s5-4", "s5-5", "s5-12"
]);
